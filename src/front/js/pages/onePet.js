...
export const OnePet = () => {
    ...
    return (
        <div className="container">
            ...
            <button className="btn btn-secondary mt-3" onClick={fetchCareInfo}>
                <i className="fas fa-info-circle"></i> Cuidados
            </button>
            {careInfo && (
                <div>
                    <h3>Cuidados</h3>
            ...
            <button className="btn btn-secondary mt-3" onClick={fetchCompatibilityInfo}>
                <i className="fas fa-info-circle"></i> Compatibilidad
            </button>
            {compatibilityInfo && (
                <div>
