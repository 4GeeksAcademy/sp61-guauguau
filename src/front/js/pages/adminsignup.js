...
export const AdminSignUp = () => {
    ...
    return (
        <>
            <div className="inner-page-banner"></div>
                        ...
                        <div className="col-md-8 col-lg-6">
                            <form className="form-styled" onSubmit={handleSubmit}>
                                ...
                                <div className="form-row align-items-center">
                                    <div className="col-md-auto">
                                        <div className="custom-control custom-checkbox mb-3 mb-md-0">
                                            <input type="checkbox" className="custom-control-input mr-2" id="sign-in-checkbox"></input>
                                ...
                                <div className="button-group">
                                    ...
                                    <Link to="/">
                                        <button className="primary-btn primary-btn1 mt-2">Back home</button>
                                    </Link>
                                </div>
